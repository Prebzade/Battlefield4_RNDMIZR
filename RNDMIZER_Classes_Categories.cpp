...
int RNDMIZER_Classes_Categories()
{
	...
	string assaultMutator[] = {"NO TEAMMATE HEAL", "NO HEALING AT ALL", "NO REVIVING RANDOMS", "DONT REVIVE AT ALL", "NOOB TUBE TIME"};
	...
	string engineerMutator[] = {"AA MAIN", "AT MAIN", ""};
	...
	//Mutators
	string mutator[] = {};
	string attachementMutator[] = { "NO ATTACHEMENTS", "SILENCER ONLY", "ONLY IRON SIGHT", "ONLY RED DOT", "SCOPE WITH HIGHEST MAGNIFICATION", "NO FOREGRIP" };
	string movementMutator[] = { "NO RUNNING", "NO CROUCHING", "NO JUMPING", "NO VAULTING", "ONLY CRAWLING", "ONLY CROUCHING", "NOTHING" };
}